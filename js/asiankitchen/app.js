...
let koreaList = menu.filter((menu) => { return menu.category == "Korea" });
let japanList = menu.filter((menu) => { return menu.category == "Japan" });
let chinaList = menu.filter((menu) => { return menu.category == "China" });

const body = document.querySelector("body")
const menuList = document.querySelector(".section-center");
const btnCard = document.querySelector(".btn-container");
...
btnCard.addEventListener("click", display);
...
function show(e) {
  e.forEach((item) => {
    menuList.innerHTML += ` <div id= ${item.id} class="menu-items ${item.category}">
